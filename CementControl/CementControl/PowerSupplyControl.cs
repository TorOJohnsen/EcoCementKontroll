...
namespace CementControl
{
    public class PowerSupplyControl
    {
        ...
        public PowerSupplyControl(ISerialConnection serialConnection)
        {
            ...
            _voltageOff = Convert.ToDouble(ConfigurationManager.AppSettings["app:voltageTurnOn"]);
            _voltageOn  = Convert.ToDouble(ConfigurationManager.AppSettings["app:voltageTurnOff"]);
        }
